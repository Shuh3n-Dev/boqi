  ...
  return (
    <section className="w-full px-gutter mb-xl pt-8 md:pt-0 relative overflow-hidden">
      ...
      >
        <motion.span
          variants={item}
          className="text-label-sm text-label-sm uppercase tracking-widest bg-accent/10 text-accent px-sm py-xs rounded"
        >
        ...
        <motion.h1
          variants={item}
          className="text-display text-display text-on-background leading-tight"
        >
          Boqi:{" "}
        ...
        <motion.p
          variants={item}
          className="text-body-lg text-body-lg text-on-surface-variant max-w-2xl"
        >
      ...
      {/* Hero Asset — Calendar mockup */}
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.5, ease: "easeOut" }}
        className="mt-xl w-[70%] mx-auto max-w-[1280px] relative rounded-lg overflow-hidden border border-outline-variant shadow-sm"
      >
        <div className="bg-white p-md md:p-lg">
